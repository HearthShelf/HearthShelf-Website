...
function Settings({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "eyebrow"
  }, "Make it yours"), /*#__PURE__*/React.createElement("h1", {
    className: "title-xl"
    ...
    className: "sr-d"
  }, "Dark is home; light for daytime reading.")), /*#__PURE__*/React.createElement(Seg, {
    value: t.theme,
    ...
    className: "sr-t"
  }, "Accent from cover"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "Let the artwork colour the controls and glow.")), /*#__PURE__*/React.createElement(Toggle, {
    on: t.accentMode === "dynamic",
    onClick: () => setTweak("accentMode", t.accentMode === "dynamic" ? "manual" : "dynamic")
  })), /*#__PURE__*/React.createElement("div", {
    className: "set-row",
    style: {
    ...
    className: "sr-t"
  }, "Manual accent"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "Pick a fixed colour for chrome.")), /*#__PURE__*/React.createElement("div", {
    className: "swatch-row"
  }, HS.PRESETS.map(p => /*#__PURE__*/React.createElement("div", {
    key: p.name,
    title: p.name,
    ...
    className: "sr-t"
  }, "Cover-glow intensity"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "How strongly the cover blooms behind the page.")), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: "0",
    max: "60",
    value: t.glow,
    ...
    className: "sr-t"
  }, "Cover style"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "Float artwork on the page, or sit it on cards.")), /*#__PURE__*/React.createElement(Seg, {
    value: t.coverStyle,
    ...
    className: "sr-t"
  }, "Colour everywhere"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "Tint the whole app, not just the player.")), /*#__PURE__*/React.createElement(Toggle, {
    ...
    className: "sr-t"
  }, "Default speed"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "Starting playback rate for new books.")), /*#__PURE__*/React.createElement(Seg, {
    value: "1.4",
    onChange: () => {},
    options: [{
      v: "1",
    ...
    className: "sr-t"
  }, "Skip intervals"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "Rewind / fast-forward jump length.")), /*#__PURE__*/React.createElement(Seg, {
    value: "30",
    onChange: () => {},
    options: [{
      v: "15",
    ...
    className: "sr-t"
  }, "Autoplay next in series"), /*#__PURE__*/React.createElement("div", {
    className: "sr-d"
  }, "Roll into the next book automatically.")), /*#__PURE__*/React.createElement(Toggle, {
    on: true,
    onClick: () => {}
  }))));
}
...
function App() {
  ...
  const effectiveAccent = t.accentMode === "manual" ? t.accentHex : t.colorEverywhere || route === "player" ? now ? now.cv : EMBER : EMBER;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: appRef,
    className: "app" + (t.coverStyle === "cards" ? " cards" : "") + (isPlayer ? " player-mode" : "")
  }, /*#__PURE__*/React.createElement("div", {
    className: "app-glow"
  ...
  }), route === "library" && /*#__PURE__*/React.createElement(Library, {
    openBook: openBook,
    onPlay: openPlayer
  }), route === "series" && /*#__PURE__*/React.createElement(SeriesView, {
    openSeries: openSeries
  }), route === "seriesDetail" && /*#__PURE__*/React.createElement(SeriesDetail, {
    series: seriesSel,
    openBook: openBook,
    onPlay: openPlayer,
    back: () => go("series")
  }), route === "stats" && /*#__PURE__*/React.createElement(Stats, null), route === "settings" && /*#__PURE__*/React.createElement(Settings, {
    t: t,
    setTweak: setTweak
  }), route === "player" && /*#__PURE__*/React.createElement(Player, {
    now: now,
    playing: playing,
    toggle: toggle,
    openBook: openBook,
...
if (__hsRoot) ReactDOM.createRoot(__hsRoot).render(/*#__PURE__*/React.createElement(App, null));
...
function Cover({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "cv-kicker"
  }, book.kicker), /*#__PURE__*/React.createElement("div", {
    className: "cv-title"
...
function coverBadge(book) {
  if (book.finished) return /*#__PURE__*/React.createElement("span", {
...
function BookTile({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "b-author"
  }, book.author), book.progress > 0 && !book.finished && /*#__PURE__*/React.createElement("div", {
    className: "b-prog"
...
function SectionHead({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: icon
  }), /*#__PURE__*/React.createElement("h2", null, title), onMore && /*#__PURE__*/React.createElement("button", {
    className: "more",
    onClick: onMore
  }, "See all \u2192"));
}
...
function UserMenu() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "person"
  }), " Profile"), /*#__PURE__*/React.createElement("button", null, /*#__PURE__*/React.createElement(Icon, {
    name: "group"
  }), " Switch user"), /*#__PURE__*/React.createElement("button", null, /*#__PURE__*/React.createElement(Icon, {
    name: "manage_accounts"
  }), " Account & server"), /*#__PURE__*/React.createElement("div", {
    className: "sep"
  }), /*#__PURE__*/React.createElement("button", {
    className: "danger"
  }, /*#__PURE__*/React.createElement(Icon, {
    ...
    className: "u-name"
  }, "Jordan Reese"), /*#__PURE__*/React.createElement("span", {
    className: "u-sub"
  }, "hearthshelf.local")), /*#__PURE__*/React.createElement(Icon, {
    name: "expand_less",
    className: "u-chev"
  })));
}
function Sidebar({
  ...
  return /*#__PURE__*/React.createElement("aside", {
    ...
    className: "bd"
  }, "Shelf"))), /*#__PURE__*/React.createElement("nav", {
    className: "nav"
  }, nav.map(n => {
    ...
    name: "settings",
    fill: route === "settings"
  }), "Settings")), /*#__PURE__*/React.createElement(UserMenu, null));
}
...
function PlayBar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "pb-title"
  }, now.title), /*#__PURE__*/React.createElement("div", {
    className: "pb-sub"
  }, now.author))), /*#__PURE__*/React.createElement("div", {
    className: "pb-center"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    name: "replay_30"
  }), /*#__PURE__*/React.createElement("small", null, "30")), /*#__PURE__*/React.createElement("button", {
    className: "pb-play",
    onClick: toggle
  }, /*#__PURE__*/React.createElement(Icon, {
    ...
    className: "pb-time"
  }, /*#__PURE__*/React.createElement("span", null, fmt(elapsed)), /*#__PURE__*/React.createElement("div", {
    className: "scrub"
  }, /*#__PURE__*/React.createElement("i", {
    style: {
  ...
  })), /*#__PURE__*/React.createElement("span", null, "-", fmt(total - elapsed)))), /*#__PURE__*/React.createElement("div", {
    className: "pb-right"
  }, /*#__PURE__*/React.createElement("button", {
    className: "pill"
...
(function () {
  ...
  (function () {
    const PAL = ["#c4663a", "#b85c4a", "#a84738", "#cc5b4a", "#b07a3c", "#3f7d8c", "#4f9db0", "#2f9d8f", "#3d8c7a", "#5e76c4", "#5566b8", "#3d4a8c", "#9b6fb8", "#7c6fbf", "#7fa86b", "#b6843a", "#c8487e", "#2e6fb0", "#4db6ac", "#a84738"];
    const TITLES = ["The First Ember", "Ashen Roads", "The Kiln King", "Smoke & Salt", "The Ninth Forge", "Cinderwake", "The Hollow Hearth", "Emberfall", "The Long Banking", "Coals of the Deep", "The Tinder Court", "Ash Lanterns", "The Quenching", "Firebreak", "The Last Bellows", "Ashes, Rising", "The Ember Throne", "Glasswork", "The Dying Light", "Hearthbound"];
    const ids = [];
    TITLES.forEach((t, i) => {
      const id = "e" + (i + 1);
      ids.push(id);
...
const DESC = "A quietly absorbing listen, narrated with warmth and restraint. The kind of book you put on at dusk and look up to find the room has gone dark around you — the only light the glow of the story itself.";
...
function Home({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "eyebrow"
  }, "HearthShelf"), /*#__PURE__*/React.createElement("h1", {
    className: "title-xl"
  }, "Good evening, Jordan"), /*#__PURE__*/React.createElement("p", {
    className: "page-sub"
  }, "You're 52% through ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: "var(--text)"
    }
  }, hero.title), " \xB7 6 books on the go")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 32,
      alignItems: "center",
  ...
  }, "Jump back in"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontSize: 30,
      fontWeight: 700,
  ...
  }, hero.author, " \xB7 Narrated by ", hero.narrator), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 16,
  ...
  }, hero.rating, " \xB7 ", hero.hours, "h \xB7 Ch ", Math.round(hero.chapters * hero.progress), "/", hero.chapters)), /*#__PURE__*/React.createElement("div", {
    className: "prog-line",
    style: {
      maxWidth: 460,
      marginBottom: 22
    ...
    fill: true
  }), " ", hero.progress > 0 ? "Resume" : "Start listening"), /*#__PURE__*/React.createElement("button", {
    className: "pill",
    onClick: () => openBook(hero)
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "info"
  }), " Details")))), HS.SHELVES.map(sh => /*#__PURE__*/React.createElement("div", {
    className: "section",
    key: sh.id
    ...
    className: "shelf-row"
  }, sh.books.map(bid => /*#__PURE__*/React.createElement(BookTile, {
    key: bid,
    book: HS.byId[bid],
    onOpen: openBook,
    onPlay: onPlay,
...
function Library({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "eyebrow"
  }, "Your collection"), /*#__PURE__*/React.createElement("h1", {
    className: "title-xl"
    ...
    className: "lib-grid"
  }, books.map(b => /*#__PURE__*/React.createElement(BookTile, {
    key: b.id,
    book: b,
    onOpen: openBook,
    onPlay: onPlay,
...
function SeriesView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "eyebrow"
  }, "Collected works"), /*#__PURE__*/React.createElement("h1", {
    className: "title-xl"
  }, "Series"), /*#__PURE__*/React.createElement("p", {
    className: "page-sub"
  }, HS.SERIES.length, " series \xB7 grouped by metadata")), /*#__PURE__*/React.createElement("div", {
    ...
    }, s.books.slice(0, 4).map(b => /*#__PURE__*/React.createElement(Cover, {
      key: b,
      book: HS.byId[b],
      fs: 7
    ...
    }, /*#__PURE__*/React.createElement("h3", null, s.name), /*#__PURE__*/React.createElement("p", null, s.author, " \xB7 ", s.books.length, " ", s.books.length === 1 ? "book" : "books", " \xB7 ", done, " finished"), /*#__PURE__*/React.createElement("div", {
      className: "sc-prog"
    }, /*#__PURE__*/React.createElement("div", {
      className: "prog-line",
      style: {
...
function HeroCovers({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, layout === "solo" && /*#__PURE__*/React.createElement(Cover, {
    book: books[0],
    fs: 13
  }), layout === "duo" && books.slice(0, 2).map(b => /*#__PURE__*/React.createElement(Cover, {
    key: b.id,
    book: b,
    fs: 11
  })), layout === "tri" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "hc-row"
  }, books.slice(0, 2).map(b => /*#__PURE__*/React.createElement(Cover, {
    key: b.id,
    book: b,
    fs: 10
  }))), /*#__PURE__*/React.createElement("div", {
    ...
    book: books[2],
    fs: 10
  }))), layout === "square" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "hc-grid"
  }, books.slice(0, 4).map(b => /*#__PURE__*/React.createElement(Cover, {
    key: b.id,
    book: b,
    fs: 8
...
function SeriesDetail({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "arrow_back"
  }), " All series"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "eyebrow"
  }, "Series"), /*#__PURE__*/React.createElement("h1", {
    className: "title-xl"
  ...
  }, series.author, " \xB7 ", books.length, " books \xB7 ", totalH.toFixed(0), "h total"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "sp-cap"
  }, done, " of ", books.length, " finished \xB7 ", listenedH.toFixed(0), "h of ", totalH.toFixed(0), "h")), /*#__PURE__*/React.createElement("div", {
    className: "sp-track"
  }, books.map(b => /*#__PURE__*/React.createElement("div", {
    key: b.id,
    className: "sp-seg" + (b.finished ? " done" : b.progress > 0 ? " part" : ""),
    title: "Book " + b.seriesNum + " · " + (b.finished ? "finished" : b.progress > 0 ? Math.round(b.progress * 100) + "%" : "not started")
  }, b.progress > 0 && !b.finished && /*#__PURE__*/React.createElement("i", {
    style: {
    ...
    name: "play_arrow",
    fill: true
  }), " Continue \xB7 Book ", nextUp.seriesNum), /*#__PURE__*/React.createElement("button", {
    className: "pill"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "playlist_add"
  }), " Add series to list"))), /*#__PURE__*/React.createElement("div", {
    className: "hero-prog",
    ...
    className: "sl-num"
  }, b.seriesNum), /*#__PURE__*/React.createElement(Cover, {
    book: b,
    fs: 6,
    className: "sl-cover"
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "sl-title"
  }, b.title, b.finished && /*#__PURE__*/React.createElement(Icon, {
    name: "check_circle",
    fill: true,
    style: {
      fontSize: 16,
    ...
    className: "sl-sub"
  }, b.narrator, " \xB7 ", b.hours, "h \xB7 ", b.chapters, " chapters"), b.progress > 0 && !b.finished && /*#__PURE__*/React.createElement("div", {
    className: "prog-line",
    style: {
      marginTop: 8,
      maxWidth: 280
...
function Stats() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "label"
  }, "Total listening time"), /*#__PURE__*/React.createElement("div", {
    className: "big-num"
  }, s.totalH, /*#__PURE__*/React.createElement("u", null, "h"), s.totalM, /*#__PURE__*/React.createElement("u", null, "m")), /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--text-muted)",
      fontSize: 14
    }
  }, "That's ", s.days)), /*#__PURE__*/React.createElement("div", {
    className: "stat-tiles"
  }, s.tiles.map((t, i) => /*#__PURE__*/React.createElement("div", {
    className: "tile",
    key: i
  }, /*#__PURE__*/React.createElement("div", {
    className: "t-ico",
    ...
    className: "t-cap"
  }, t.cap)))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "bars"
  }, s.week.map((d, i) => /*#__PURE__*/React.createElement("div", {
    className: "bar-col" + (i === hotIdx ? " hot" : ""),
    key: i
  }, /*#__PURE__*/React.createElement("span", {
    className: "v"
  }, d.v, "h"), /*#__PURE__*/React.createElement("div", {
    className: "bar",
    style: {
      height: d.v / max * 100 + "%"
    }
    ...
    className: "d"
  }, d.d))))), /*#__PURE__*/React.createElement(Compare, {
    c: s.compare
  }));
}
...
function Compare({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, c.percentile, /*#__PURE__*/React.createElement("u", null, "th"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      fontWeight: 600
    }
  }, "Top ", 100 - c.percentile, "% this month"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "var(--text-muted)",
      marginTop: 4
    }
  }, "You listened more than ", c.percentile, "% of HearthShelf readers."))), /*#__PURE__*/React.createElement("div", {
    className: "cmp-bars"
  }, c.bars.map((b, i) => /*#__PURE__*/React.createElement("div", {
    className: "cmp-row",
    key: i
  }, /*#__PURE__*/React.createElement("span", {
    className: "cmp-label"
    ...
    className: "cmp-val"
  }, b.v, "h"))))), /*#__PURE__*/React.createElement("div", {
    className: "chart-card",
    style: {
      marginTop: 0
    }
  ...
  }, "Server leaderboard"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12.5,
      color: "var(--text-muted)",
      marginBottom: 14
    }
  }, "Hours listened \xB7 last 30 days"), /*#__PURE__*/React.createElement("div", {
    className: "lb-list"
  }, c.friends.map(f => /*#__PURE__*/React.createElement("div", {
...
function Player({
  ...
  if (!now) return /*#__PURE__*/React.createElement("div", {
    className: "page"
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "reorder"
  }), " Queue"))), /*#__PURE__*/React.createElement(Cover, {
    book: now,
    fs: 26,
    ...
    className: "p-pct"
  }, Math.round(now.progress * 100), /*#__PURE__*/React.createElement("small", null, ".0%")), /*#__PURE__*/React.createElement("div", {
    className: "p-ch"
  }, "Ch ", curIdx + 1, " / ", now.chapters)), /*#__PURE__*/React.createElement("div", {
    className: "prog-line"
  }, /*#__PURE__*/React.createElement("i", {
    style: {
      width: now.progress * 100 + "%"
    ...
    className: "p-times"
  }, /*#__PURE__*/React.createElement("span", null, fmt(elapsed), " elapsed"), /*#__PURE__*/React.createElement("span", null, fmt(total - elapsed), " left")), /*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
      marginTop: 28,
      textAlign: "center"
    ...
    className: "p-times"
  }, /*#__PURE__*/React.createElement("span", null, fmt(cur.mins * chElapsedRatio)), /*#__PURE__*/React.createElement("span", null, "-", fmt(cur.mins * (1 - chElapsedRatio))))), /*#__PURE__*/React.createElement("div", {
    ...
    name: "info"
  }), " Book details"), /*#__PURE__*/React.createElement("button", {
    className: "pill",
    ...
    name: "bedtime"
  }), " Sleep timer"), /*#__PURE__*/React.createElement("button", {
    className: "pill"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "bookmark_add"
    ...
    "aria-hidden": !open
  }, panel === "chapters" && /*#__PURE__*/React.createElement(PlayerChapters, {
    book: now,
    chapters: chapters,
    curIdx: curIdx,
    onClose: () => setPanel(null)
  }), panel === "details" && /*#__PURE__*/React.createElement(PlayerDetails, {
    book: now,
    onClose: () => setPanel(null)
  })));
}
...
function PlayerChapters({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "n"
  }, c.now ? /*#__PURE__*/React.createElement(Icon, {
    name: "graphic_eq",
    fill: true,
    style: {
      fontSize: 16
...
function PlayerDetails({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "by"
  }, "by ", /*#__PURE__*/React.createElement("b", null, book.author)), /*#__PURE__*/React.createElement("div", {
    className: "by",
    style: {
      marginTop: 2
    }
  }, "Read by ", /*#__PURE__*/React.createElement("b", null, book.narrator)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }, book.rating)))), /*#__PURE__*/React.createElement("div", {
    ...
    name: c.i
  }), " ", c.t))), series && /*#__PURE__*/React.createElement("div", {
    className: "set-row",
    style: {
      background: "var(--c)",
      borderRadius: 12,
    ...
    className: "sr-d"
  }, "Book ", book.seriesNum, " of ", series.books.length)), /*#__PURE__*/React.createElement(Icon, {
    name: "chevron_right",
    style: {
      color: "var(--text-muted)"
    }
...
function BookSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("h1", null, book.title), /*#__PURE__*/React.createElement("div", {
    className: "by"
  }, "by ", /*#__PURE__*/React.createElement("b", null, book.author)), /*#__PURE__*/React.createElement("div", {
    className: "by",
    style: {
  ...
  }, "Narrated by ", /*#__PURE__*/React.createElement("b", null, book.narrator)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 10,
  ...
  }, book.rating, " on Audible")), book.progress > 0 && !book.finished && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "prog-line"
  }, /*#__PURE__*/React.createElement("i", {
    style: {
      width: book.progress * 100 + "%"
  ...
  }, Math.round(book.progress * 100), "% \xB7 ", Math.round(book.chapters * (1 - book.progress)), " chapters left")))), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    style: {
      width: "100%",
      marginTop: 22
    ...
    name: "play_arrow",
    fill: true
  }), " ", book.finished ? "Listen again" : book.progress > 0 ? "Resume listening" : "Start listening"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10,
      marginTop: 12
    ...
    name: "task_alt"
  }), " ", book.finished ? "Finished" : "Mark finished"), /*#__PURE__*/React.createElement("button", {
    className: "pill",
    style: {
      flex: 1,
      justifyContent: "center"
    ...
    className: "chap-list"
  }, chapters.slice(0, 8).map(c => /*#__PURE__*/React.createElement("div", {
    className: "chap" + (c.now ? " now" : "") + (c.done ? " done" : ""),
    key: c.n
  }, /*#__PURE__*/React.createElement("span", {
    className: "n"
    ...
    className: "cd"
  }, fmt(c.mins)))), chapters.length > 8 && /*#__PURE__*/React.createElement("div", {
    className: "chap",
    style: {
      justifyContent: "center",
      color: "var(--text-muted)",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "app/screens.jsx", error: String((e && e.message) || e) }); }
...
function Button({
  ...
  const variants = {
    ...
    secondary: {
      background: hover ? "color-mix(in oklab, var(--secondary) 80%, var(--foreground) 6%)" : "var(--secondary)",
    ...
    destructive: {
      background: hover ? "color-mix(in oklab, var(--destructive) 88%, #fff)" : "var(--destructive)",
...
function NavItem({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      background: active ? "color-mix(in oklab, var(--primary) 15%, transparent)" : hover ? "var(--fill)" : "transparent",
...
function ProgressBar({
  ...
  }), scrubber && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      top: "50%",
      left: pct + "%",
...
function HoverActions({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      background: "linear-gradient(to top, rgba(8,6,4,0.8), rgba(8,6,4,0.12) 56%, transparent 82%)"
    }
    ...
    primary: true,
    title: "Play"
  }), onAdd && /*#__PURE__*/React.createElement(Btn, {
    on: onAdd,
    icon: "playlist_add",
    title: "Add to list"
  }), onFinish && /*#__PURE__*/React.createElement(Btn, {
    on: onFinish,
    icon: "check",
    title: "Mark finished"
  }), onMore && /*#__PURE__*/React.createElement(Btn, {
    on: onMore,
    icon: "more_horiz",
    title: "More"
  }));
...
function BookTile({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      boxShadow: card ? "none" : hover ? "var(--shadow-lift)" : "0 10px 28px rgba(0,0,0,0.4)"
    },
    badge: book.finished ? /*#__PURE__*/React.createElement("span", {
      style: {
        position: "absolute",
        top: 8,
        right: 8,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/media/BookTile.jsx", error: String((e && e.message) || e) }); }
...
function PlayBar({
  ...
  }, icon), label && /*#__PURE__*/React.createElement("small", {
    style: {
      position: "absolute",
      bottom: 1,
      left: "50%",
  ...
  }, playing ? "pause" : "play_arrow")), /*#__PURE__*/React.createElement(Skip, {
    icon: "forward_30",
    label: "30"
  }), /*#__PURE__*/React.createElement(Skip, {
    icon: "skip_next"
  ...
  }, speed, "\xD7"), ["bedtime", "queue_music", "volume_up"].map(i => /*#__PURE__*/React.createElement("button", {
    key: i,
    style: {
      width: 38,
      height: 38,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/media/PlayBar.jsx", error: String((e && e.message) || e) }); }
